  ...
  return (
    ...
    >
      ...
      >
        ...
        <View>
          <Image style={{
            width: 100, height: 100, borderWidth: 1, borderColor: "#000", borderRadius: 5
        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row' }}>
              <TouchableOpacity >
                ...
                <View style={{ paddingHorizontal: 10, paddingVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                  <FontAwesome5 name={'heart'} size={20} style={{ color: "black" }} />
              ...
              <TouchableOpacity>
                ...
                <View style={{ paddingHorizontal: 10, paddingVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                  <FontAwesome5 name={'trash'} size={18} style={{ color: "black" }} />
          ...
          <View style={{ flexDirection: 'row', }}>
            <Text style={{ flexGrow: 1, color: 'black', marginStart: 10,alignSelf:'flex-end',fontWeight:'bold' }}>$10</Text>

            <View style={{ flexDirection: "row" }} >
              <TouchableOpacity style={{borderWidth:1,borderColor:'gray',borderRadius:5}}>

                <View style={{ paddingHorizontal: 10, paddingVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                  <FontAwesome5 name={'plus'} size={14} style={{ color: "gray" }} />

                </View>
              </TouchableOpacity>


              <View style={{ paddingHorizontal: 10, paddingVertical: 10, justifyContent: 'center', alignItems: 'center' ,backgroundColor:'gray',borderRadius:5}}>
              ...
              <TouchableOpacity style={{borderWidth:1,borderColor:'gray',borderRadius:5}}>
                ...
                <View style={{ paddingHorizontal: 10, paddingVertical: 10, justifyContent: 'center', alignItems: 'center' }}>
                  <FontAwesome5 name={'minus'} size={14} style={{ color: "gray" }} />
